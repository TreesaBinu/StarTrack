...
<html id="top">
    ...
    <body id="Student Home">
		...
		<ul>
			...
			<hr class="navb">
			<hr class="navb">
                                <a href="#atudenthome.jsp">Home</a>
				<a href="markview.jsp">View Marks</a>
				<a href="studentmentoring.jsp">Mentoring</a>
				<hr class="navb">
                        </div><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
                        <div class="content">
            <form action="addsachievementsact.jsp" enctype="multipart/form-data" name="sample" method="post">
                <input type="text" name="name" required="" autocomplete="off">
                <br>
             <input type="file" name="myimg" required="" autocomplete="off">
                <br>  
                <br>
